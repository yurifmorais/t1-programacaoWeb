        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="mostrarVeiculo.php">Mostrar</a>
                    </li>
                </ul>
                ...
                foreach ($resultados as $resultado) {
                    echo "
                            <tr>
                                ...
                                <td>$resultado[km]</td>
                                <td><a class='btn btn-success' href='editarVeiculo.php?codigo=$resultado[codigo]'>Editar</a></td>
                            </tr>
                        ";
                }
                ?>
